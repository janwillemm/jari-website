...
<section class="tools-section">
  <div class="container">
    <div class="callout-marker tools-notice" role="note" aria-label="Toelichting bij onze tools">
      <span class="callout-marker__icon" aria-hidden="true">ℹ️</span>
      <p>
    ...
    <ul class="tool-card-grid">
      ...
      {% for tool in tools %}
        <li>
          <a class="tool-card tool-card--{{ tool.status }}" href="{{ '/tools/' | append: tool.slug | append: '/' | relative_url }}">
